...
public class CNameSensor extends CElement {
  private static final IJSONO sensorNameConfig = cbf.getJSONOFromString("{\"loc\":[\"xpath\",\"//*[@id='sensor.Name']\",\"webview\"],\"name\":\"sensorName\"}");
  ...
  public CNameSensor(IConfig config) {
    super(config);
  }

  @Override
  public CNameSensor initComponents(int... optTimeoutInSecs) {
  ...
  @Override
  public CNameSensor collectData() {
    if (elementExists()) {
      super.collectData();
  ...
  @Override
  protected CNameSensor createComponents() {
