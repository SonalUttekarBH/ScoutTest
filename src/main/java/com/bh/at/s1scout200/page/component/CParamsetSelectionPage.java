...
public class CParamsetSelectionPage extends CElement {
  private static final IJSONO paramsetListConfig = cbf.getJSONOFromString("{\"loc\":[\"xpath\",\"//*[@id='paramsetsList']\",\"webview\"],\"name\":\"paramsetList\"}");

  private static final IJSONO addParamConfig = cbf.getJSONOFromString("{\"loc\":[\"xpath\",\"//*[@test-tag='measureparamsetsview_add_button']\"],\"name\":\"addParam\"}");

  private static final IJSONO editParamConfig = cbf.getJSONOFromString("{\"loc\":[\"xpath\",\"//*[@test-tag='measureparamsetsview_editmode_button']\"],\"name\":\"editParam\"}");

  private static final IJSONO selectionModeConfig = cbf.getJSONOFromString("{\"loc\":[\"xpath\",\"//*[@test-tag='measureparamsetsview_selectionmode_button']\"],\"name\":\"selectionMode\"}");

  public CElements<IText> paramsetList;
  ...
  public CParamsetSelectionPage(IConfig config) {
    super(config);
  }

  @Override
  public CParamsetSelectionPage initComponents(int... optTimeoutInSecs) {
    super.initComponents(optTimeoutInSecs);
    paramsetList.init(optTimeoutInSecs);
  ...
  @Override
  public CParamsetSelectionPage collectData() {
    if (elementExists()) {
      super.collectData();
      paramsetList.collectData();
  ...
  @Override
  protected CParamsetSelectionPage createComponents() {
    super.createComponents();
    paramsetList = new CElements<>(CText::new, UiHelper.config.createConfig(paramsetListConfig, this));
