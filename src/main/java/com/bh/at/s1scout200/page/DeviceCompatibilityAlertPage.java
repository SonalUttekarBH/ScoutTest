...
public class DeviceCompatibilityAlertPage extends CMobilePage {
  private static final IJSONO okConfig = cbf.getJSONOFromString("{\"loc\":[\"xpath\",\"//*[@resource-id='done']\"],\"name\":\"ok\"}");

  public IButton ok;

  public DeviceCompatibilityAlertPage(IJSONO uiDriverCaps) {
    super(uiDriverCaps);
  }
  ...
  @Override
  public DeviceCompatibilityAlertPage init(int... optTimeoutInSecs) {
  ...
  @Override
  public DeviceCompatibilityAlertPage initComponents(int... optTimeoutInSecs) {
  ...
  @Override
  public DeviceCompatibilityAlertPage collectData() {
    super.collectData();
    ok.collectData();
  ...
  @Override
  protected DeviceCompatibilityAlertPage createComponents() {
