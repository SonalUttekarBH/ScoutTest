...
public class CSensorType extends CElement {
  private static final IJSONO typeConfig = cbf.getJSONOFromString("{\"loc\":[\"xpath\",\"//*[contains(@test-tag,'sensordrivecurrent_')]\",\"webview\"],\"name\":\"type\"}");

  public CElements<IText> type;

  public CSensorType(IConfig config) {
    super(config);
  }

  @Override
  public CSensorType initComponents(int... optTimeoutInSecs) {
  ...
  @Override
  public CSensorType collectData() {
    if (elementExists()) {
      super.collectData();
      type.collectData();
    }
  ...
  @Override
  protected CSensorType createComponents() {
    super.createComponents();
    type = new CElements<>(CText::new, UiHelper.config.createConfig(typeConfig, this));
