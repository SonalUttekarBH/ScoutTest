...
public class CSensorAutoSettling extends CElement {
  private static final IJSONO autosettlingConfig = cbf.getJSONOFromString("{\"loc\":[\"xpath\",\"//*[contains(@test-tag,'sensorautosettling_')]\",\"webview\"],\"name\":\"autosettling\"}");

  public CElements<IText> autosettling;

  public CSensorAutoSettling(IConfig config) {
    super(config);
  }

  @Override
  public CSensorAutoSettling initComponents(int... optTimeoutInSecs) {
  ...
  @Override
  public CSensorAutoSettling collectData() {
    if (elementExists()) {
      super.collectData();
  ...
  @Override
  protected CSensorAutoSettling createComponents() {
    super.createComponents();
    autosettling = new CElements<>(CText::new, UiHelper.config.createConfig(autosettlingConfig, this));
